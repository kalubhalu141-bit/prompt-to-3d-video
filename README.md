...
**T2V/I2V models + talking-head + animation ecosystem** — Apache-2.0 / MIT
- [AnimateDiff](https://github.com/guoyww/AnimateDiff) · [Wan 2.2](https://github.com/Wan-Video/Wan2.2) · [LTX-Video](https://github.com/Lightricks/LTX-Video) · [Open-Sora](https://github.com/hpcaitech/Open-Sora) · [CogVideo](https://github.com/zai-org/CogVideo) · [FramePack](https://github.com/lllyasviel/FramePack) · [TurboDiffusion](https://github.com/thu-ml/TurboDiffusion) · [Pixelle-Video](https://github.com/ATH-MaaS/Pixelle-Video) · [HunyuanVideo](https://github.com/Tencent-Hunyuan/HunyuanVideo) (Tencent Community, NOT bundled) · [Stable Video Infinity](https://github.com/vita-epfl/Stable-Video-Infinity) · [Paper2Video](https://github.com/showlab/Paper2Video) · [Code2Video](https://github.com/showlab/Code2Video) · [MotionDirector](https://github.com/showlab/MotionDirector) · [Hallo](https://github.com/fudan-generative-vision/hallo) · [Champ](https://github.com/fudan-generative-vision/champ) · [First Order Model](https://github.com/AliaksandrSiarohin/first-order-model) · [StableAnimator](https://github.com/Francis-Rings/StableAnimator) · [Make-A-Video](https://github.com/lucidrains/make-a-video-pytorch) · [WebGPU-Video-Diffusion](https://github.com/WebGPU-Video-Diffusion/WebGPU-Video-Diffusion)

**Talking-head / audio-driven / lip-sync** — MIT
- [Whisper](https://github.com/openai/whisper) (108k★) · [whisper.cpp](https://github.com/ggml-org/whisper.cpp) (53k★) · [Faster-Whisper](https://github.com/SYSTRAN/faster-whisper) · [Buzz](https://github.com/chidiwilliams/buzz) · [WhisperSpeech](https://github.com/WhisperSpeech/WhisperSpeech) · [EasyVtuber](https://github.com/yuyuyzl/EasyVtuber) · [LivePortrait](https://github.com/kijai/ComfyUI-LivePortraitKJ) · [talking-head-anime-demo](https://github.com/pkhungurn/talking-head-anime-demo) · [uLipSync](https://github.com/hecomi/uLipSync) · [TalkingHead 3D](https://github.com/met4citizen/TalkingHead)

**3D / R3F / WebGPU / Three.js ecosystem** — MIT
- [Three.js](https://github.com/mrdoob/three.js) · [React Three Fiber](https://github.com/pmndrs/react-three-fiber) (32k★) · [drei](https://github.com/pmndrs/drei) · [pmndrs/postprocessing](https://github.com/pmndrs/postprocessing) · [Filament](https://github.com/google/filament) · [three-mesh-bvh](https://github.com/gkjohnson/three-mesh-bvh) · [simple-peer](https://github.com/feross/simple-peer) · [DL Streamer](https://github.com/open-edge-platform/dlstreamer)

**2D animation / motion graphics** — MIT
- [Lottie](https://github.com/airbnb/lottie-web) (32k★) · [mo.js](https://github.com/mojs/mojs) (19k★) · [GSAP](https://github.com/greensock/gsap-skills) (14.5k★) · [Tixl](https://github.com/tixl3d/tixl) · [Motionity](https://github.com/alyssaxuu/motionity) · [Astrofox](https://github.com/astrofox-io/astrofox) · [Pixel Composer](https://github.com/Ttanasart-pt/Pixel-Composer) · [nexrender](https://github.com/inlife/nexrender) · [Vue-Lottie](https://github.com/chenqingspring/vue-lottie) · [react-design-editor](https://github.com/salgum1114/react-design-editor)

**VFX / post-processing / node-based** — MIT
- [Seriously.js](https://github.com/brianchirls/Seriously.js) (3.9k★) · [vfx-js](https://github.com/fand/vfx-js) · [Vibe-Workflow](https://github.com/SamurAIGPT/Vibe-Workflow) · [ai-shortVideo-pipeline](https://github.com/myccarl/ai-shortVideo-pipeline)
...
**Image↔Video merge / subtitles / transcoding** — Apache-2.0 / MIT
- [InfiniteTalk](https://github.com/MeiGen-AI/InfiniteTalk) · [video-retalking](https://github.com/OpenTalker/video-retalking) · [VideoLingo](https://github.com/Huanshere/VideoLingo) (18k★) · [video-subtitle-remover](https://github.com/YaoFANGUK/video-subtitle-remover) · [video-subtitle-extractor](https://github.com/YaoFANGUK/video-subtitle-extractor) · [auto-subtitle](https://github.com/m1guelpf/auto-subtitle) · [html-video](https://github.com/nexu-io/html-video) · [video-shotcraft](https://github.com/Vincentwei1021/video-shotcraft) · [VideoPipe](https://github.com/sherlockchou86/VideoPipe) · [react-native-video-processing](https://github.com/shahen94/react-native-video-processing) · [Polyvia](https://github.com/Ovilia/Polyvia) · [DPlayer](https://github.com/DIYgod/DPlayer) (16k★) · [JiaoZiVideoPlayer](https://github.com/lipangit/JiaoZiVideoPlayer) (10k★) · [videojs-player](https://github.com/surmon-china/videojs-player) · [Cabbage](https://github.com/VideoFlint/Cabbage) · [FFdynamic](https://github.com/Xingtao/FFdynamic) · [streamio-ffmpeg](https://github.com/streamio/streamio-ffmpeg) · [goffmpeg](https://github.com/xfrr/goffmpeg)
